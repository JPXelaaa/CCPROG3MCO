/* Main class
  This provides the user interface for creating, viewing, 
  managing hotels, and simulating bookings through a text-based menu system.
 */
...
public class Main {
  ...
  */
  private static void createHotel() {
    ...
    if (hotelSystem.createHotel(hotelName)) {
      ...
      System.out.println("A default room named 'A01' has been added to the hotel.");
    } else {
      ...
      switch (choice) {
        ...
        case 4:
          if(hotel.getReservations().isEmpty()){
            ...
            System.out.println("Cannot change base price while there are reservations.");
          }
          break;
        case 5:
  ...
  */
  ...
  /* isHotelNameUnique Method
      a. Purpose: Checks if the provided hotel name is unique in the system.
      b. Parameters: 
         - hotelName (String): The name of the hotel to check for uniqueness.
  ...
  */
  ...
  /* removeCurrentHotel Method
      a. Purpose: Similar to the method above but is utilized during the "Manage Hotel Section"
      b. Parameters: 
